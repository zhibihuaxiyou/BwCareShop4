...
public class RegistActivity extends AppCompatActivity implements LoginOrRegistView {
    ...
    Button mBtnRegist;
    private LoginOrRegistPresenter registPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registPresenter = new LoginOrRegistPresenter(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_regist:
                map = new HashMap<>();
                regist_phone = mEditRegistMobile.getText().toString().trim();
